...
Route::group(array('prefix' => 'admin', 'before' => 'auth'), function(){
	...
	*/
	...
	Route::get('catalogs/images/', array( 'uses' => 'Controllers\Admin\CatalogImagesController@lists', 'as' => 'admin.catalogs.images.home'));
	...
	Route::get('catalogs/{catalogs}/products/{products}/delete', array( 'uses' => 'Controllers\Admin\CatalogProductsController@destroy', 'as' => 'admin.catalogs.products.destroy'));
	...
	*/
	...
	Route::resource('products.images', 'Controllers\Admin\ProductImagesController', array('only' => array('edit')));
	Route::get('products/{products}/images/{images}/delete', array( 'uses' => 'Controllers\Admin\ProductImagesController@destroy', 'as' => 'admin.products.images.destroy'));
	...
	*/
	...
	Route::get('galleries/images/', array( 'uses' => 'Controllers\Admin\GalleryImagesController@lists', 'as' => 'admin.galleries.images.lists'));
	Route::resource('galleries.images', 'Controllers\Admin\GalleryImagesController', array('except' => array('store', 'update', 'destroy')));
	Route::get('galleries/{galleries}/images/{images}/delete', array( 'uses' => 'Controllers\Admin\GalleryImagesController@destroy', 'as' => 'admin.galleries.images.destroy'));
