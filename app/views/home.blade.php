        ...
        <div class="sub-inner">
            ...
            <div class="row-fluid works">
                <div class="span3">
                    ...
                    <h4>Primera imagen de Galeria #1</h4>
                    <p>Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                </div>
                <div class="span3">
                    <a href="portfolio-single" class="thumbnail">
                        <img src="example/latest2.jpg" alt="">
                        <span class="frame-overlay"></span>
                    </a>
                    <h4>Primera imagen de Galeria #2</h4>
                    <p>Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                </div>
                <div class="span3">
                    <a href="portfolio-single" class="thumbnail">
                        <img src="example/latest3.jpg" alt="">
                        <span class="frame-overlay"></span>
                    </a>
                    <h4>Primera imagen de Galeria #3</h4>
                    <p>Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                </div>
                <div class="span3">
                    <a href="portfolio-single" class="thumbnail">
                        <img src="example/latest4.jpg" alt="">
                        <span class="frame-overlay"></span>
                    </a>
                    <h4>Primera imagen de Galeria #4</h4>
                    <p>Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                </div>
            </div>
