...
@section('buttons')
		...
		<a href="{{ route('admin.catalogs.products.index', $catalog->id) }}"><button class="btn" title="Listar productos"><i class="icon-list"></i> Listar</button></a>
		<a href="{{ route('admin.catalogs.products.edit', array($catalog->id, $product->id)) }}"><button class="btn" title="Modificar este producto"><i class="icon-pencil"></i> Editar</button></a>
				...
				<div class="span5">
					<div class="btn-toolbar clearfix">
						<div class="btn-group pull-right">
							<a href="{{ route('admin.products.edit', $product->id) }}"><button class="btn" title="Crear y agregar un nuevo producto a este catalogo"><i class="icon-plus"></i> Agregar</button></a>
						</div>
					</div>
				</div>
			</div>
