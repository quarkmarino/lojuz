...
@section('buttons')
	{{--<a href="{{ route('admin.galleries.create') }}" onclick="return confirm('¿Esta seguro que desea salir sin guardar los detalles de la galeria?')">
		<button class="btn" title="Crear nuevo galeria"><i class="icon-plus"></i> Crear</button>
	</a>--}}
	{{--<a href="{{ route('admin.galleries.index') }}" onclick="return confirm('¿Esta seguro que desea salir sin guardar los detalles de la galeria?')">
		<button class="btn" title="Listar galerias"><i class="icon-list"></i> Listar</button>
	</a>--}}
	{{--<a href="{{ route('admin.galleries.show', $gallery->id) }}" onclick="return confirm('¿Esta seguro que desea salir sin guardar los detalles de la galeria?')">
		<button class="btn" title="Ver este galeria"><i class="icon-eye-open"></i> Ver</button>
	</a>--}}
	<a href="{{ route('admin.galleries.show', $gallery->id) }}" onclick="return confirm('¿Esta seguro que desea salir sin guardar los detalles de la galeria?')">
		<button class="btn" title="Volver a la galeria"><i class="icon-backward"></i> Volver</button>
	</a>
	<a class="delete" href="{{ route('admin.galleries.destroy', $gallery->id) }}" onclick="return confirm('¿Esta seguro que desea eliminar la galeria \'{{ $gallery->name }}\' y todas sus imagenes relacionadas?')">
		<button class="btn" title="Eliminar galeria"><i class="icon-trash"></i> Eliminar</button>
	</a>
@stop
