	...
	<div class="row-fluid">
		<div class="span6">
			...
			<div class="page-inner">
				{{ Form::open( array('route' => 'admin.products.store', 'class' => 'af-form form-horizontal', 'id' => 'product-form') ) }}
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="input-prepend">
										...
										{{ Form::select('catalog_id', $catalogs, isset($catalog) ? $catalog->id : Input::old('catalog_id'), array('class' => 'span10', 'id' => 'inputCatalogs')) }}
									</div>
								</div>
							</div>
						</div>
		...
		<div class="span6">
			...
			<div class="page-inner">
				<p>
					La carga de imagenes estara disponible una vez que se haya creado el producto/servicio, desde el formulario de edición.
				</p>
			</div>
		</div>
	</div>
